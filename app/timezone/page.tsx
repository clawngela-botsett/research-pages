...
const ALL_SEARCHABLE_CITIES: TZOption[] = [
  // 🇺🇸 United States
  { label: 'Los Angeles', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'San Francisco', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Seattle', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Las Vegas', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Portland', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'San Diego', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Phoenix', flag: '🇺🇸', iana: 'America/Phoenix' },
  { label: 'Denver', flag: '🇺🇸', iana: 'America/Denver' },
  { label: 'Salt Lake City', flag: '🇺🇸', iana: 'America/Denver' },
  { label: 'Chicago', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Dallas', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Houston', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Minneapolis', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'New Orleans', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'San Antonio', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Kansas City', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Austin', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'New York', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Miami', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Atlanta', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Boston', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Washington DC', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Philadelphia', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Detroit', flag: '🇺🇸', iana: 'America/Detroit' },
  { label: 'Nashville', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Charlotte', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Orlando', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Tampa', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Honolulu', flag: '🇺🇸', iana: 'Pacific/Honolulu' },
  { label: 'Anchorage', flag: '🇺🇸', iana: 'America/Anchorage' },
  // 🇨🇦 Canada
  { label: 'Toronto', flag: '🇨🇦', iana: 'America/Toronto' },
  { label: 'Vancouver', flag: '🇨🇦', iana: 'America/Vancouver' },
  { label: 'Montreal', flag: '🇨🇦', iana: 'America/Toronto' },
  { label: 'Calgary', flag: '🇨🇦', iana: 'America/Edmonton' },
  { label: 'Ottawa', flag: '🇨🇦', iana: 'America/Toronto' },
  { label: 'Edmonton', flag: '🇨🇦', iana: 'America/Edmonton' },
  { label: 'Winnipeg', flag: '🇨🇦', iana: 'America/Winnipeg' },
  { label: 'Halifax', flag: '🇨🇦', iana: 'America/Halifax' },
  // 🌎 Latin America & Caribbean
  { label: 'Mexico City', flag: '🇲🇽', iana: 'America/Mexico_City' },
  { label: 'Cancún', flag: '🇲🇽', iana: 'America/Cancun' },
  { label: 'Guadalajara', flag: '🇲🇽', iana: 'America/Mexico_City' },
  { label: 'São Paulo', flag: '🇧🇷', iana: 'America/Sao_Paulo' },
  { label: 'Rio de Janeiro', flag: '🇧🇷', iana: 'America/Sao_Paulo' },
  { label: 'Brasília', flag: '🇧🇷', iana: 'America/Sao_Paulo' },
  { label: 'Buenos Aires', flag: '🇦🇷', iana: 'America/Argentina/Buenos_Aires' },
  { label: 'Santiago', flag: '🇨🇱', iana: 'America/Santiago' },
  { label: 'Bogotá', flag: '🇨🇴', iana: 'America/Bogota' },
  { label: 'Lima', flag: '🇵🇪', iana: 'America/Lima' },
  { label: 'Caracas', flag: '🇻🇪', iana: 'America/Caracas' },
  { label: 'Quito', flag: '🇪🇨', iana: 'America/Guayaquil' },
  { label: 'Panama City', flag: '🇵🇦', iana: 'America/Panama' },
  { label: 'San José', flag: '🇨🇷', iana: 'America/Costa_Rica' },
  { label: 'Guatemala City', flag: '🇬🇹', iana: 'America/Guatemala' },
  { label: 'Havana', flag: '🇨🇺', iana: 'America/Havana' },
  { label: 'Santo Domingo', flag: '🇩🇴', iana: 'America/Santo_Domingo' },
  { label: 'San Juan', flag: '🇵🇷', iana: 'America/Puerto_Rico' },
  // 🇬🇧 United Kingdom
  { label: 'London', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Manchester', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Edinburgh', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Birmingham', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Dublin', flag: '🇮🇪', iana: 'Europe/Dublin' },
  // 🌍 Western Europe
  { label: 'Paris', flag: '🇫🇷', iana: 'Europe/Paris' },
  { label: 'Lyon', flag: '🇫🇷', iana: 'Europe/Paris' },
  { label: 'Berlin', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Munich', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Frankfurt', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Hamburg', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Amsterdam', flag: '🇳🇱', iana: 'Europe/Amsterdam' },
  { label: 'Brussels', flag: '🇧🇪', iana: 'Europe/Brussels' },
  { label: 'Zurich', flag: '🇨🇭', iana: 'Europe/Zurich' },
  { label: 'Geneva', flag: '🇨🇭', iana: 'Europe/Zurich' },
  { label: 'Madrid', flag: '🇪🇸', iana: 'Europe/Madrid' },
  { label: 'Barcelona', flag: '🇪🇸', iana: 'Europe/Madrid' },
  { label: 'Lisbon', flag: '🇵🇹', iana: 'Europe/Lisbon' },
  { label: 'Rome', flag: '🇮🇹', iana: 'Europe/Rome' },
  { label: 'Milan', flag: '🇮🇹', iana: 'Europe/Rome' },
  { label: 'Vienna', flag: '🇦🇹', iana: 'Europe/Vienna' },
  { label: 'Prague', flag: '🇨🇿', iana: 'Europe/Prague' },
  { label: 'Copenhagen', flag: '🇩🇰', iana: 'Europe/Copenhagen' },
  { label: 'Stockholm', flag: '🇸🇪', iana: 'Europe/Stockholm' },
  { label: 'Oslo', flag: '🇳🇴', iana: 'Europe/Oslo' },
  { label: 'Helsinki', flag: '🇫🇮', iana: 'Europe/Helsinki' },
  { label: 'Athens', flag: '🇬🇷', iana: 'Europe/Athens' },
  { label: 'Budapest', flag: '🇭🇺', iana: 'Europe/Budapest' },
  { label: 'Warsaw', flag: '🇵🇱', iana: 'Europe/Warsaw' },
  { label: 'Kyiv', flag: '🇺🇦', iana: 'Europe/Kyiv' },
  { label: 'Bucharest', flag: '🇷🇴', iana: 'Europe/Bucharest' },
  { label: 'Sofia', flag: '🇧🇬', iana: 'Europe/Sofia' },
  { label: 'Istanbul', flag: '🇹🇷', iana: 'Europe/Istanbul' },
  { label: 'Ankara', flag: '🇹🇷', iana: 'Europe/Istanbul' },
  { label: 'Moscow', flag: '🇷🇺', iana: 'Europe/Moscow' },
  { label: 'St. Petersburg', flag: '🇷🇺', iana: 'Europe/Moscow' },
  // 🌍 Africa
  { label: 'Cairo', flag: '🇪🇬', iana: 'Africa/Cairo' },
  { label: 'Cape Town', flag: '🇿🇦', iana: 'Africa/Johannesburg' },
  { label: 'Johannesburg', flag: '🇿🇦', iana: 'Africa/Johannesburg' },
  { label: 'Durban', flag: '🇿🇦', iana: 'Africa/Johannesburg' },
  { label: 'Nairobi', flag: '🇰🇪', iana: 'Africa/Nairobi' },
  { label: 'Lagos', flag: '🇳🇬', iana: 'Africa/Lagos' },
  { label: 'Abuja', flag: '🇳🇬', iana: 'Africa/Lagos' },
  { label: 'Accra', flag: '🇬🇭', iana: 'Africa/Accra' },
  { label: 'Casablanca', flag: '🇲🇦', iana: 'Africa/Casablanca' },
  { label: 'Algiers', flag: '🇩🇿', iana: 'Africa/Algiers' },
  { label: 'Tunis', flag: '🇹🇳', iana: 'Africa/Tunis' },
  { label: 'Addis Ababa', flag: '🇪🇹', iana: 'Africa/Addis_Ababa' },
  { label: 'Dar es Salaam', flag: '🇹🇿', iana: 'Africa/Dar_es_Salaam' },
  { label: 'Kampala', flag: '🇺🇬', iana: 'Africa/Kampala' },
  { label: 'Dakar', flag: '🇸🇳', iana: 'Africa/Dakar' },
  { label: 'Khartoum', flag: '🇸🇩', iana: 'Africa/Khartoum' },
  { label: 'Luanda', flag: '🇦🇴', iana: 'Africa/Luanda' },
  { label: 'Harare', flag: '🇿🇼', iana: 'Africa/Harare' },
  { label: 'Lusaka', flag: '🇿🇲', iana: 'Africa/Lusaka' },
  { label: 'Maputo', flag: '🇲🇿', iana: 'Africa/Maputo' },
  { label: 'Antananarivo', flag: '🇲🇬', iana: 'Indian/Antananarivo' },
  // 🌍 Middle East
  { label: 'Dubai', flag: '🇦🇪', iana: 'Asia/Dubai' },
  { label: 'Abu Dhabi', flag: '🇦🇪', iana: 'Asia/Dubai' },
  { label: 'Riyadh', flag: '🇸🇦', iana: 'Asia/Riyadh' },
  { label: 'Jeddah', flag: '🇸🇦', iana: 'Asia/Riyadh' },
  { label: 'Doha', flag: '🇶🇦', iana: 'Asia/Qatar' },
  { label: 'Kuwait City', flag: '🇰🇼', iana: 'Asia/Kuwait' },
  { label: 'Manama', flag: '🇧🇭', iana: 'Asia/Bahrain' },
  { label: 'Muscat', flag: '🇴🇲', iana: 'Asia/Muscat' },
  { label: 'Tel Aviv', flag: '🇮🇱', iana: 'Asia/Jerusalem' },
  { label: 'Jerusalem', flag: '🇮🇱', iana: 'Asia/Jerusalem' },
  { label: 'Amman', flag: '🇯🇴', iana: 'Asia/Amman' },
  { label: 'Beirut', flag: '🇱🇧', iana: 'Asia/Beirut' },
  { label: 'Baghdad', flag: '🇮🇶', iana: 'Asia/Baghdad' },
  { label: 'Tehran', flag: '🇮🇷', iana: 'Asia/Tehran' },
  // 🌏 South & Central Asia
  { label: 'Mumbai', flag: '🇮🇳', iana: 'Asia/Kolkata' },
  { label: 'Delhi', flag: '🇮🇳', iana: 'Asia/Kolkata' },
  { label: 'Bangalore', flag: '🇮🇳', iana: 'Asia/Kolkata' },
  { label: 'Chennai', flag: '🇮🇳', iana: 'Asia/Kolkata' },
  { label: 'Hyderabad', flag: '🇮🇳', iana: 'Asia/Kolkata' },
  { label: 'Kolkata', flag: '🇮🇳', iana: 'Asia/Kolkata' },
  { label: 'Karachi', flag: '🇵🇰', iana: 'Asia/Karachi' },
  { label: 'Lahore', flag: '🇵🇰', iana: 'Asia/Karachi' },
  { label: 'Islamabad', flag: '🇵🇰', iana: 'Asia/Karachi' },
  { label: 'Dhaka', flag: '🇧🇩', iana: 'Asia/Dhaka' },
  { label: 'Colombo', flag: '🇱🇰', iana: 'Asia/Colombo' },
  { label: 'Kathmandu', flag: '🇳🇵', iana: 'Asia/Kathmandu' },
  { label: 'Kabul', flag: '🇦🇫', iana: 'Asia/Kabul' },
  { label: 'Tashkent', flag: '🇺🇿', iana: 'Asia/Tashkent' },
  { label: 'Almaty', flag: '🇰🇿', iana: 'Asia/Almaty' },
  // 🌏 Southeast & East Asia
  { label: 'Bangkok', flag: '🇹🇭', iana: 'Asia/Bangkok' },
  { label: 'Ho Chi Minh City', flag: '🇻🇳', iana: 'Asia/Ho_Chi_Minh' },
  { label: 'Hanoi', flag: '🇻🇳', iana: 'Asia/Bangkok' },
  { label: 'Phnom Penh', flag: '🇰🇭', iana: 'Asia/Phnom_Penh' },
  { label: 'Yangon', flag: '🇲🇲', iana: 'Asia/Yangon' },
  ...
  { label: 'Bali', flag: '🇮🇩', iana: 'Asia/Makassar' },
  { label: 'Manila', flag: '🇵🇭', iana: 'Asia/Manila' },
  { label: 'Hong Kong', flag: '🇭🇰', iana: 'Asia/Hong_Kong' },
  { label: 'Taipei', flag: '🇹🇼', iana: 'Asia/Taipei' },
  { label: 'Shanghai', flag: '🇨🇳', iana: 'Asia/Shanghai' },
  { label: 'Beijing', flag: '🇨🇳', iana: 'Asia/Shanghai' },
  { label: 'Guangzhou', flag: '🇨🇳', iana: 'Asia/Shanghai' },
  { label: 'Shenzhen', flag: '🇨🇳', iana: 'Asia/Shanghai' },
  { label: 'Chengdu', flag: '🇨🇳', iana: 'Asia/Shanghai' },
  { label: 'Seoul', flag: '🇰🇷', iana: 'Asia/Seoul' },
  { label: 'Busan', flag: '🇰🇷', iana: 'Asia/Seoul' },
  { label: 'Tokyo', flag: '🇯🇵', iana: 'Asia/Tokyo' },
  { label: 'Osaka', flag: '🇯🇵', iana: 'Asia/Tokyo' },
  { label: 'Kyoto', flag: '🇯🇵', iana: 'Asia/Tokyo' },
  { label: 'Ulaanbaatar', flag: '🇲🇳', iana: 'Asia/Ulaanbaatar' },
  // 🇦🇺 Australia & Pacific
  ...
  { label: 'Adelaide', flag: '🇦🇺', iana: 'Australia/Adelaide' },
  { label: 'Darwin', flag: '🇦🇺', iana: 'Australia/Darwin' },
  { label: 'Canberra', flag: '🇦🇺', iana: 'Australia/Sydney' },
  { label: 'Auckland', flag: '🇳🇿', iana: 'Pacific/Auckland' },
  { label: 'Wellington', flag: '🇳🇿', iana: 'Pacific/Auckland' },
  { label: 'Fiji', flag: '🇫🇯', iana: 'Pacific/Fiji' },
  { label: 'Guam', flag: '🇬🇺', iana: 'Pacific/Guam' },
  // 🇺🇸 More US cities
  { label: 'Sacramento', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'San Jose', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Oakland', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Reno', flag: '🇺🇸', iana: 'America/Los_Angeles' },
  { label: 'Tucson', flag: '🇺🇸', iana: 'America/Phoenix' },
  { label: 'Albuquerque', flag: '🇺🇸', iana: 'America/Denver' },
  { label: 'Colorado Springs', flag: '🇺🇸', iana: 'America/Denver' },
  { label: 'Boise', flag: '🇺🇸', iana: 'America/Boise' },
  { label: 'Oklahoma City', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Memphis', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'St. Louis', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Milwaukee', flag: '🇺🇸', iana: 'America/Chicago' },
  { label: 'Cincinnati', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Cleveland', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Pittsburgh', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Baltimore', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Indianapolis', flag: '🇺🇸', iana: 'America/Indiana/Indianapolis' },
  { label: 'Columbus', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Louisville', flag: '🇺🇸', iana: 'America/Kentucky/Louisville' },
  { label: 'Richmond', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Raleigh', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Jacksonville', flag: '🇺🇸', iana: 'America/New_York' },
  { label: 'Fort Lauderdale', flag: '🇺🇸', iana: 'America/New_York' },
  // 🌎 More Latin America
  { label: 'Monterrey', flag: '🇲🇽', iana: 'America/Monterrey' },
  { label: 'Tijuana', flag: '🇲🇽', iana: 'America/Tijuana' },
  { label: 'Medellín', flag: '🇨🇴', iana: 'America/Bogota' },
  { label: 'Cali', flag: '🇨🇴', iana: 'America/Bogota' },
  { label: 'Montevideo', flag: '🇺🇾', iana: 'America/Montevideo' },
  { label: 'Asunción', flag: '🇵🇾', iana: 'America/Asuncion' },
  { label: 'La Paz', flag: '🇧🇴', iana: 'America/La_Paz' },
  { label: 'Guayaquil', flag: '🇪🇨', iana: 'America/Guayaquil' },
  { label: 'Managua', flag: '🇳🇮', iana: 'America/Managua' },
  { label: 'Tegucigalpa', flag: '🇭🇳', iana: 'America/Tegucigalpa' },
  { label: 'Nassau', flag: '🇧🇸', iana: 'America/Nassau' },
  { label: 'Kingston', flag: '🇯🇲', iana: 'America/Jamaica' },
  { label: 'Port of Spain', flag: '🇹🇹', iana: 'America/Port_of_Spain' },
  { label: 'Georgetown', flag: '🇬🇾', iana: 'America/Guyana' },
  { label: 'Paramaribo', flag: '🇸🇷', iana: 'America/Paramaribo' },
  // 🌍 More Europe
  { label: 'Reykjavik', flag: '🇮🇸', iana: 'Atlantic/Reykjavik' },
  { label: 'Glasgow', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Cardiff', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Belfast', flag: '🇬🇧', iana: 'Europe/London' },
  { label: 'Porto', flag: '🇵🇹', iana: 'Europe/Lisbon' },
  { label: 'Seville', flag: '🇪🇸', iana: 'Europe/Madrid' },
  { label: 'Valencia', flag: '🇪🇸', iana: 'Europe/Madrid' },
  { label: 'Bilbao', flag: '🇪🇸', iana: 'Europe/Madrid' },
  { label: 'Marseille', flag: '🇫🇷', iana: 'Europe/Paris' },
  { label: 'Nice', flag: '🇫🇷', iana: 'Europe/Paris' },
  { label: 'Bordeaux', flag: '🇫🇷', iana: 'Europe/Paris' },
  { label: 'Cologne', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Düsseldorf', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Stuttgart', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'Leipzig', flag: '🇩🇪', iana: 'Europe/Berlin' },
  { label: 'The Hague', flag: '🇳🇱', iana: 'Europe/Amsterdam' },
  { label: 'Rotterdam', flag: '🇳🇱', iana: 'Europe/Amsterdam' },
  { label: 'Antwerp', flag: '🇧🇪', iana: 'Europe/Brussels' },
  { label: 'Luxembourg City', flag: '🇱🇺', iana: 'Europe/Luxembourg' },
  { label: 'Monaco', flag: '🇲🇨', iana: 'Europe/Monaco' },
  { label: 'Bern', flag: '🇨🇭', iana: 'Europe/Zurich' },
  { label: 'Basel', flag: '🇨🇭', iana: 'Europe/Zurich' },
  { label: 'Florence', flag: '🇮🇹', iana: 'Europe/Rome' },
  { label: 'Venice', flag: '🇮🇹', iana: 'Europe/Rome' },
  { label: 'Naples', flag: '🇮🇹', iana: 'Europe/Rome' },
  { label: 'Turin', flag: '🇮🇹', iana: 'Europe/Rome' },
  { label: 'Salzburg', flag: '🇦🇹', iana: 'Europe/Vienna' },
  { label: 'Bratislava', flag: '🇸🇰', iana: 'Europe/Bratislava' },
  { label: 'Ljubljana', flag: '🇸🇮', iana: 'Europe/Ljubljana' },
  { label: 'Zagreb', flag: '🇭🇷', iana: 'Europe/Zagreb' },
  { label: 'Sarajevo', flag: '🇧🇦', iana: 'Europe/Sarajevo' },
  { label: 'Belgrade', flag: '🇷🇸', iana: 'Europe/Belgrade' },
  { label: 'Skopje', flag: '🇲🇰', iana: 'Europe/Skopje' },
  { label: 'Tirana', flag: '🇦🇱', iana: 'Europe/Tirane' },
  { label: 'Tallinn', flag: '🇪🇪', iana: 'Europe/Tallinn' },
  { label: 'Riga', flag: '🇱🇻', iana: 'Europe/Riga' },
  { label: 'Vilnius', flag: '🇱🇹', iana: 'Europe/Vilnius' },
  { label: 'Minsk', flag: '🇧🇾', iana: 'Europe/Minsk' },
  { label: 'Chisinau', flag: '🇲🇩', iana: 'Europe/Chisinau' },
  { label: 'Tbilisi', flag: '🇬🇪', iana: 'Asia/Tbilisi' },
  { label: 'Yerevan', flag: '🇦🇲', iana: 'Asia/Yerevan' },
  { label: 'Baku', flag: '🇦🇿', iana: 'Asia/Baku' },
  { label: 'Nicosia', flag: '🇨🇾', iana: 'Asia/Nicosia' },
  { label: 'Valletta', flag: '🇲🇹', iana: 'Europe/Malta' },
  // 🌍 More Africa
  { label: 'Alexandria', flag: '🇪🇬', iana: 'Africa/Cairo' },
  { label: 'Tripoli', flag: '🇱🇾', iana: 'Africa/Tripoli' },
  { label: 'Rabat', flag: '🇲🇦', iana: 'Africa/Casablanca' },
  { label: 'Marrakech', flag: '🇲🇦', iana: 'Africa/Casablanca' },
  { label: 'Douala', flag: '🇨🇲', iana: 'Africa/Douala' },
  { label: 'Kinshasa', flag: '🇨🇩', iana: 'Africa/Kinshasa' },
  { label: 'Brazzaville', flag: '🇨🇬', iana: 'Africa/Brazzaville' },
  { label: 'Accra', flag: '🇬🇭', iana: 'Africa/Accra' },
  { label: 'Abidjan', flag: '🇨🇮', iana: 'Africa/Abidjan' },
  { label: 'Dakar', flag: '🇸🇳', iana: 'Africa/Dakar' },
  { label: 'Bamako', flag: '🇲🇱', iana: 'Africa/Bamako' },
  { label: 'Conakry', flag: '🇬🇳', iana: 'Africa/Conakry' },
  { label: 'Freetown', flag: '🇸🇱', iana: 'Africa/Freetown' },
  { label: 'Monrovia', flag: '🇱🇷', iana: 'Africa/Monrovia' },
  { label: 'Mogadishu', flag: '🇸🇴', iana: 'Africa/Mogadishu' },
  { label: 'Djibouti', flag: '🇩🇯', iana: 'Africa/Djibouti' },
  { label: 'Asmara', flag: '🇪🇷', iana: 'Africa/Asmara' },
  { label: 'Windhoek', flag: '🇳🇦', iana: 'Africa/Windhoek' },
  { label: 'Gaborone', flag: '🇧🇼', iana: 'Africa/Gaborone' },
  { label: 'Lilongwe', flag: '🇲🇼', iana: 'Africa/Blantyre' },
  { label: 'Mbabane', flag: '🇸🇿', iana: 'Africa/Mbabane' },
  { label: 'Maseru', flag: '🇱🇸', iana: 'Africa/Maseru' },
  { label: 'Mauritius', flag: '🇲🇺', iana: 'Indian/Mauritius' },
  { label: 'Réunion', flag: '🇷🇪', iana: 'Indian/Reunion' },
  // 🌍 More Middle East
  { label: 'Gaza', flag: '🇵🇸', iana: 'Asia/Gaza' },
  { label: 'Sana\'a', flag: '🇾🇪', iana: 'Asia/Aden' },
  { label: 'Erbil', flag: '🇮🇶', iana: 'Asia/Baghdad' },
  { label: 'Damascus', flag: '🇸🇾', iana: 'Asia/Damascus' },
  // 🌏 More Asia
  { label: 'Lahore', flag: '🇵🇰', iana: 'Asia/Karachi' },
  { label: 'Islamabad', flag: '🇵🇰', iana: 'Asia/Karachi' },
  { label: 'Peshawar', flag: '🇵🇰', iana: 'Asia/Karachi' },
  { label: 'Colombo', flag: '🇱🇰', iana: 'Asia/Colombo' },
  { label: 'Kathmandu', flag: '🇳🇵', iana: 'Asia/Kathmandu' },
  { label: 'Thimphu', flag: '🇧🇹', iana: 'Asia/Thimphu' },
  { label: 'Rangoon', flag: '🇲🇲', iana: 'Asia/Yangon' },
  { label: 'Vientiane', flag: '🇱🇦', iana: 'Asia/Vientiane' },
  { label: 'Dili', flag: '🇹🇱', iana: 'Asia/Dili' },
  { label: 'Brunei', flag: '🇧🇳', iana: 'Asia/Brunei' },
  { label: 'Macau', flag: '🇲🇴', iana: 'Asia/Macau' },
  { label: 'Pyongyang', flag: '🇰🇵', iana: 'Asia/Pyongyang' },
  { label: 'Vladivostok', flag: '🇷🇺', iana: 'Asia/Vladivostok' },
  { label: 'Novosibirsk', flag: '🇷🇺', iana: 'Asia/Novosibirsk' },
  { label: 'Yekaterinburg', flag: '🇷🇺', iana: 'Asia/Yekaterinburg' },
  // 🌊 More Pacific & Islands
  { label: 'Papeete', flag: '🇵🇫', iana: 'Pacific/Tahiti' },
  { label: 'Noumea', flag: '🇳🇨', iana: 'Pacific/Noumea' },
  { label: 'Port Moresby', flag: '🇵🇬', iana: 'Pacific/Port_Moresby' },
  { label: 'Honiara', flag: '🇸🇧', iana: 'Pacific/Guadalcanal' },
  { label: 'Suva', flag: '🇫🇯', iana: 'Pacific/Fiji' },
  { label: 'Nuku\'alofa', flag: '🇹🇴', iana: 'Pacific/Tongatapu' },
  { label: 'Apia', flag: '🇼🇸', iana: 'Pacific/Apia' },
  { label: 'Funafuti', flag: '🇹🇻', iana: 'Pacific/Funafuti' },
  { label: 'Majuro', flag: '🇲🇭', iana: 'Pacific/Majuro' },
  { label: 'Maldives', flag: '🇲🇻', iana: 'Indian/Maldives' },
  { label: 'Seychelles', flag: '🇸🇨', iana: 'Indian/Mahe' },
  { label: 'Comoros', flag: '🇰🇲', iana: 'Indian/Comoro' },
]
